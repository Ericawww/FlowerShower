...
CREATE TABLE `course` (
  ...
  `outline` TEXT COLLATE utf8mb4_general_ci DEFAULT NULL,
  `coursePhoto` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`courseNumber`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;


insert into `course` values("031E0031","毛泽东思想和中国特色社会主义理论体系概论","Intro.to Mao Thought & Theoretical System of China Socialism","马克思主义学院",4,"无","本课程全面系统阐述马克思主义中国化的两大理论成果——毛泽东思想和中国特色社会主义理论体系，帮助学生掌握建设中国特色社会主义的总依据和总任务，了解中国特色社会主义改革开放的发展历程，掌握建设中国特色社会主义的总布局；同时，要全面了解中国特色社会主义的外交和国际战略，明确建设中国特色社会主义的根本目的和依靠力量，掌握建设中国特色社会主义的领导核心就是坚持共产党的领导，全面提高党的建设的科学化水平，全面从严治党。要帮助学生树立正确的世界观、人生观和价值观，学会运用马克思主义的世界观和方法论去认识和分析问题，坚持中国特色社会主义的道路自信、理论自信、制度自信和文化自信，不断把中国特色社会主义推向前进。","二、教学目标
(一)学习目标
...
insert into `course` values ("21191920","数据驱动安全","Data-driven Security","计算机科学与技术学院","2.0","高级数据结构与算法分析、机器学习基础、信息安全原理","本课程主要涉及三个方面的内容：（1）数据驱动安全基础：数据分析理论、威胁情报分析技术、网络攻防技术、隐私保护技术等基础理论与技术；（2）数据驱动安全关键技术及应用：口令攻击与防御、验证码攻击与防御、网络威胁与犯罪分析；（3）高级数据安全：对抗学习理论以及对抗图像、对抗文本、对抗音视频等对抗样本生成技术。","（一）学习目标
...
INSERT INTO `user` VALUES ('1111', '应承峻', '123', '3170103456@zju.edu.cn', '17326084929', '1999-06-22', '1', '0', '/images/user.png', 'ycjsb');
...
/*class*/
insert into class values("01","1111","031E0031","1999-04-30","2019-12-3");
