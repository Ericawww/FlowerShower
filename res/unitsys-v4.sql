...
-- Records of class
-- ----------------------------
INSERT INTO `class` VALUES ('01', '1111', '031E0031', '1999-04-30', '2019-12-03', '0', '0', '0');
...
CREATE TABLE `class_project_score` (
  ...
  `commitMsg` text COLLATE utf8mb4_general_ci,
  ...
  `complainMsg` varchar(256) COLLATE utf8mb4_general_ci DEFAULT NULL,
